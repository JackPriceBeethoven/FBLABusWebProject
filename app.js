...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function submitApplication() {
        ...
        const applicationData = {
            ...
            workedBefore: document.getElementById("worked-before").value,
            phoneNumber: document.getElementById("phone-number").value,
            state: document.getElementById("state").value,
            city: document.getElementById("city").value,
            street: document.getElementById("street").value,
            postalCode: document.getElementById("postal-code").value,
            legalToWork: document.getElementById("legal-to-work").value,
            educationLevel: document.getElementById("education-level").value,
            schoolAttended: document.getElementById("school-attended").value,
            highSchoolCity: document.getElementById("high-school-city").value,
            highSchoolState: document.getElementById("high-school-state").value,
            gradeCompleted: document.getElementById("grade-completed").value,
            country: document.getElementById("country").value,
            schoolType: document.getElementById("school-type").value,
            schoolName: document.getElementById("school-name").value,
            undergradCity: document.getElementById("undergrad-city").value,
            undergradState: document.getElementById("undergrad-state").value,
            graduationDateUndergrad: document.getElementById("graduation-date").value,
            degreeType: document.getElementById("degree-type").value,
            subjectUndergrad: document.getElementById("subject").value,
            undergradCountry: document.getElementById("undergrad-country").value,
            gradSchoolName: document.getElementById("grad-school-name").value,
            gradCity: document.getElementById("grad-city").value,
            gradState: document.getElementById("grad-state").value,
            graduationDateGrad: document.getElementById("graduation-date").value,
            degreeTypeGrad: document.getElementById("degree-type").value,
            degreeSubjectGrad: document.getElementById("degree-subject").value,
            gradCountry: document.getElementById("grad-country").value,
            employer1: document.getElementById("employer-1").value,
            employedFrom1: document.getElementById("employed-from-1").value,
            employedTo1: document.getElementById("employed-to-1").value,
            reasonForLeaving1: document.getElementById("reason-for-leaving-1").value,
            contactEmployer1: document.getElementById("contact-employer-1").value,
            employer2: document.getElementById("employer-2").value,
            employedFrom2: document.getElementById("employed-from-2").value,
            employedTo2: document.getElementById("employed-to-2").value,
            reasonForLeaving2: document.getElementById("reason-for-leaving-2").value,
            contactEmployer2: document.getElementById("contact-employer-2").value,
            employer3: document.getElementById("employer-3").value,
            employedFrom3: document.getElementById("employed-from-3").value,
            employedTo3: document.getElementById("employed-to-3").value,
            reasonForLeaving3: document.getElementById("reason-for-leaving-3").value,
            contactEmployer3: document.getElementById("contact-employer-3").value,
        ...
        if (isConfirmed) {
          ...
          xhr.send(JSON.stringify(applicationData)); 
        }
      }
